...
const Textscrlrevl = () => {
  ...
  return (
    <div style={{ backgroundColor: '#fae9d5' }} className="min-h-screen bg-white flex flex-col items-center justify-center text-center py-8 md:py-20 px-4 sm:px-6 lg:px-8">
